...
@section('title', 'Term List| InterCipta ERP Management')
        ...
        <div class="page-inner">
          ...
          <header class="page-title-bar">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                  <a href="#"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Term List</a>
                </li>
              </ol>
            </nav><!-- /.breadcrumb -->
            <!-- floating action -->
            ...
            <div class="d-md-flex align-items-md-start">
              <h1 class="page-title mr-sm-auto"> Term List </h1><!-- .btn-toolbar -->
