    ...
    <header class="app-header" style="background-color: #3E6CFF;">
        ...
        <div class="top-bar">
            ...
            <div class="top-bar-brand">
                ...
                <img src="https://production.interciptacorp.com/company-page/images/logo.png" width="140"
                    alt="">
            ...
            <div class="top-bar-list">
                ...
                <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                    ...
                    <ul class="header-nav nav">
                        <!-- .nav-item -->
                        <li class="nav-item dropdown header-nav-dropdown has-notified" style="color: white">
                            <a class="nav-link" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"><span class="oi oi-pulse"></span></a> <!-- .dropdown-menu -->
                            <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                                <div class="dropdown-arrow"></div>
                                <h6 class="dropdown-header stop-propagation">
                                    <span>Activities <span class="badge">({{ isset($notifications) ? count($notifications) : 0 }})</span></span>
                                </h6><!-- .dropdown-scroll -->
                                    ...
                                    @if(isset($notifications))
                                        ...
                                        <a href="#" class="dropdown-item unread">
                                            <div class="dropdown-item-body">
                                                <p class="text"> {{ $notification->data['data'] }} </p><span
                                                    class="date">{{ $notification->created_at->diffForHumans() }}</span>
                                            </div>
                                        </a> <!-- /.dropdown-item -->
                                        @endforeach
                                    @else
                                ...
                                @can('employee')
                                    <div class="dropdown-sheets">
                                        ...
                                        <div class="dropdown-sheet-item">
                                            <a href="{{ url('/vendors') }}" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-indigo"><i class="oi oi-people"></i></span>
                                                <span class="tile-peek">Vendors</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="{{ route('projects.create') }}" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-teal"><i class="oi oi-fork"></i></span> <span
                                                    class="tile-peek">Projects</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="{{ url('/customers') }}" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-pink"><i class="fa fa-tasks"></i></span> <span
                                                    class="tile-peek">Customers</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="{{ url('/departments') }}" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-yellow"><i class="oi oi-fire"></i></span> <span
                                                    class="tile-peek">Departments</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="{{ url('/chartofaccounts') }}" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-cyan"><i class="oi oi-document"></i></span>
                                                <span class="tile-peek">COAS</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                    </div><!-- .dropdown-sheets -->
                                @endcan
                            </div><!-- .dropdown-menu -->
                    ...
                    <!-- .btn-account -->
                    <div class="dropdown d-none d-md-flex" style="color: white">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ url('/accountsettings') }}"><span
                                    class="dropdown-icon oi oi-person"></span> Pengaturan Akun</a>
