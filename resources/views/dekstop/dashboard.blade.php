                ...
                <div class="page-inner">
                    ...
                    <header class="page-title-bar">
                        <div class="d-flex flex-column flex-md-row">
                            <p class="lead">
                                <span class="font-weight-bold">Hi, {{ Auth::user()->name }}</span> <span
                    ...
                    <div class="row">
                        <div class="masonry-item col-lg-6">
                            ...
                            <div class="card card-fluid">
                                <img src="{{ asset('/admin/images/dummy/cover.png') }}" class="card-img-top img-fluid"
                                    alt="">
                                <!-- .card-body -->
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <a href="user-profile.html" class="user-avatar user-avatar-xl">
                                                @if ($user->profile?->avatar != null)
                                                    <img src="{{ Storage::url($user ? $user->profile?->avatar : '') }}"
                                                        alt="">
                                                @else
                                                    <img src="{{ asset('/admin/images/avatars/team4.jpg') }}"
                                                        alt="">
                                                @endif
                                            </a> <!-- /.user-avatar -->
                                        </div><!-- /grid column -->
                                        ...
                                        <div class="col-auto">
                                            <p>
                                                ...
                                                <a href="{{ url('register-profile') }}" class="btn btn-primary circle">Update Profile <i class="fa fa-arrow-right ml-2"></i></a>
                                                @else
                                    ...
                                    <div class="text-center pt-3">
                                        ...
                                        <div style="padding-top: 20px">
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                data-target="#exampleModalCenter">My QR Code</button>
                                        </div>
                                    </div><!-- /easy-pie-chart -->
                                </div><!-- /.card-body -->
                            </div>
