...
@section('title', 'Edit Job | InterCipta ERP Management')
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="status" class="custom-select custom-select-lg d-block w-100"
                                                        ...
                                                        <option value="{{ $career->status }}"> Tampil </option>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select id="company_id" class="custom-select custom-select-lg d-block w-100"
                                                    ...
                                                    <option value="{{ $career->company_id }}"> {{ $career->company['company'] }}
                                                    </option>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="form-control" id="body">{{ $career->description }}</textarea>
                                                @error('jobname')
                                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                                @enderror
                                            </div>
