        ...
        <script>
            ...
            if (element) {
                element.innerHTML = element.innerHTML
                    ...
                    .replace('{TANGGAL_MULAI}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['start_date'], 'd-m-Y') }}')
                    .replace('{TANGGAL_MULAI}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['start_date'], 'd-m-Y') }}')
                    .replace('{TANGGAL_MULAI}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['start_date'], 'd-m-Y') }}')
                    .replace('{TANGGAL_MULAI}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['start_date'], 'd F Y')->format('d F Y') }}')
                    .replace('{TANGGAL_MULAI}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['start_date'], 'd-m-Y') }}')
                    .replace('{TANGGAL_BERAKHIR}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['end_date'], 'd-m-Y') }}')
                    .replace('{TANGGAL_BERAKHIR}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['end_date'], 'd-m-Y') }}')
                    .replace('{TANGGAL_BERAKHIR}', '{{ Carbon\Carbon::parse(Auth::user()->pkwt?->agreement['end_date'], 'd-m-Y') }}')
                    ...
                    .replace('{TTL}', '{{ Auth::user()->profile['birth_place'] }}, {{ Carbon\Carbon::parse(Auth::user()->profile['birth_date'], 'd-m-Y') }}')
