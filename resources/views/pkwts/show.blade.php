      ...
      <div class="page has-sidebar has-sidebar-expand-xl">
        ...
        <div class="page-inner">
          ...
          <header class="page-title-bar">
            <div class="d-md-flex">
              <h1 class="page-title"> {{ $pkwt->reference_number }} </h1>
              <div class="ml-auto">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <h2 class="card-title text-center"> {{ $pkwt->reference_number }} </h2>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-md-0 mb-4">
                        <p>: {{ $pkwt->user['name'] }}</p>
                        <p>: {{ $pkwt->user?->profile['gender'] }}</p>
                        <p>: {{ $pkwt->user?->profile['birth_place'] }}, {{ $pkwt->user?->profile['birth_date'] }}</p>
                        <p>: {{ $pkwt->user?->profile['nik_number'] }}</p>
                        <p>: {{ $pkwt->user?->profile['address'] }}</p>
                    </div>
                </div>
                ...
                <p>PIHAK PERTAMA dan PIHAK KEDUA secara bersama-sama selanjutnya disebut sebagai PARA PIHAK
                    Pada hari ini, tanggal <strong>{{ $pkwt->date_abjad }}</strong> bulan <strong>{{ $pkwt->month_abjad }}</strong> tahun <strong>{{ $pkwt->year_abjad }}</strong>, PARA PIHAK sepakat menandatangani Perjanjian Kerja dengan ketentuan-ketentuan sebagai berikut :
                    </p>
                <br>
                ...
                <p>2. PIHAK PERTAMA menawarkan dan PIHAK KEDUA menerima/bersedia untuk bekerja sebagai <strong>Trainer</strong> pada proyek<strong> {{ $pkwt->project }} area {{ $pkwt->area }}</strong> selanjutnya disebut sebagai Pihak Pemakai Jasa PIHAK PERTAMA.</p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 text-center">
                        <p>PIHAK PERTAMA</p>
                        <strong>{{ $pkwt->company['company'] }}</strong>
                        <br>
                        <br>
                        <br>
                        <p>( <u>{{ Auth::user()->name }}</u> )</p>
