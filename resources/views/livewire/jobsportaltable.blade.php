                    ...
                    <div class="col">
                        ...
                        <div class="has-clearable">
                            <button type="button" class="close" aria-label="Close"><span aria-hidden="true"><i
                                        class="fa fa-times-circle"></i></span></button> <input type="text"
                                class="form-control" placeholder="Search" wire:model="search">
                        </div><!-- /.has-clearable -->
                    </div><!-- /.col -->
                    <!-- .col-auto -->
                </div><!-- /grid row -->
                            ...
                            <div class="card">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="badge bg-muted" data-toggle="tooltip" data-placement="bottom"
                                            title="Deadline"><span class="sr-only">Deadline</span> <i
                                                class="fa fa-calendar-alt text-muted mr-1"></i>{{ \Carbon\Carbon::parse($career->created_at)->diffForHumans() }}</span>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <div class="dropdown-arrow"></div><a
                                                    href="{{ route('jobportal-show', $career->id) }}"
                                                    class="dropdown-item">View Job</a>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- /.card-header -->
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="row">
                                        <!-- grid column -->
                                        <div class="col">
                                            <strong>Salary</strong> <span class="d-block"
                                                style="color: green">{{ $career->salary }}</span>
                                        </div><!-- /grid column -->
                                        <!-- grid column -->
                                        <div class="col">
                                            <strong>Graduate</strong> <span class="d-block"><span
                                                    class="badge badge-danger">{{ $career->graduate }}</span></span>
                                        </div><!-- /grid column -->
                                    </div><!-- /grid row -->
                                </div><!-- /.card-body -->
                            </div><!-- /.card -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <div class="dropdown-arrow"></div><a
                                                    href="{{ route('karir-detail', $career->id) }}"
                                                    class="dropdown-item">View Job</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <!-- /.media -->
                                    <h5 class="card-title">
                                        <a href="{{ route('karir-detail', $career->id) }}">{{ $career->jobname }}</a>
                                    </h5>
                                    <p class="card-subtitle text-muted"> {{ $career->company['company'] }} </p>
                                    <!-- .my-3 -->
                                    <div class="my-3">
