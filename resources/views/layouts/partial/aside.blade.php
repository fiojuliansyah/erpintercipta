      ...
      <div class="aside-menu overflow-hidden">
        ...
        <nav id="stacked-menu" class="stacked-menu">
          ...
          <ul class="menu">
            ...
            <!-- .menu-header -->
            @can('admin-only')
            <li class="menu-header">Server Side <span class="badge badge-danger">Admin Only</span></li><!-- /.menu-header -->
            <!-- .menu-item -->
            <li class="menu-item has-child">
              <a href="#" class="menu-link"><span class="menu-icon fas fa-project-diagram"></span> <span class="menu-text">Data Master Setting</span></a> <!-- child menu -->
              <ul class="menu">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="{{ url('/cruds') }}" class="menu-link"><span class="menu-icon far fa-file"></span> <span class="menu-text">Cruds Example</span></a>
            </li>
            <li class="menu-item">
              <a href="{{ url('/users') }}" class="menu-link"><span class="menu-icon fas fa-user"></span> <span class="menu-text">Users</span></a>
            </li>
            <li class="menu-item">
