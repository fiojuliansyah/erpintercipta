...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('') }}admin/vendor/flatpickr/flatpickr.min.css"><!-- END PLUGINS STYLES -->
        <!-- BEGIN THEME STYLES -->
    ...
    <script>
        ...
        particlesJS.load('announcement', '{{ asset('') }}admin/javascript/pages/particles.json');
        })
