...
@section('content')
    <div class="page-content">
        ...
        <div class="card card-style" style="margin-top: 50px">
            <div class="d-flex content mb-1">
                ...
                <img src="{{ asset('') }}mobile/images/empty.png"
                    data-src="{{ Storage::url($user ? $user->profile?->avatar : '') }}" width="70" height="70"
                    class="bg-highlight rounded-circle shadow-xl preload-img">
            </div>
            @if (Auth::user()->hasRole('employee') &&
                ...
                <div class="content">
                    <div class="row mb-0">
                        <div class="col-6">
                            <a href="#"
                                class="btn btn-full btn-m rounded-s text-uppercase font-900 shadow-xl bg-highlight"><i
                                    class="fas fa-camera">&nbsp</i> IN / OUT</a>
                        </div>
                        <div class="col-6">
                            <a href="#"
                ...
                <div class="content">
                    <p>
                    <h5 class="float-left font-16 font-600">Attendance</h5>&nbsp&nbsp&nbsp&nbsp<small><span
                            class="badge badge-danger">coming soon</span></small>
                    </p>
                </div>
        ...
        @if (Auth::user()->hasRole('employee') &&
            ...
            <div class="card card-style preload-img" data-src="{{ asset('') }}mobile/images/pictures/20s.jpg"
                ...
                <div class="content pb-2">
                    <h1>
                        <i data-feather="gift" data-feather-line="1" data-feather-size="55"
                            data-feather-color="red2-dark" data-feather-bg="red2-fade-dark">
                        </i>
                    </h1>
            ...
            <div class="double-slider owl-carousel owl-no-dots text-center">
                @foreach ($careers as $item)
                    <div class="item bg-theme pb-3 rounded-m shadow-l">
                        ...
                        <a href="#"
                            class="btn btn-xs bg-highlight btn-center-xs rounded-s shadow-s text-uppercase font-900">Lamar</a>
                    </div>
                @endforeach
            </div>
    ...
    <div id="ad-timed-3" class="menu menu-box-modal">
        <div class="card-top">
            <a href="#" class="close-menu ad-time-close bg-red2-dark"><i
