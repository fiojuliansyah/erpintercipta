...
@section('title','Clock-Out | Intercipta Mobile')

@section('content')
<div class="page-content">
        
    <div class="page-title page-title-small" style="margin-top: 50px">
        <h2><a href="#" data-back-button><i class="fa fa-arrow-left"></i></a><span>clock Out</span></h2>
        <center class="pt-4">
    ...
    <form  id="input-attendance" action="{{ route('clock-out') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <input type="hidden" id="imgData" name="image_out" />
    <input type="hidden" id="longitudeInput" name="long_out" />
    <input type="hidden" id="latitudeInput" name="lat_out" />   
    </form>   
...
<div id="menu-success-1" class="menu menu-box-modal rounded-m" data-menu-height="320" data-menu-width="310">
    ...
    <h1 class="text-center mt-3 font-700">Berhasil Clock Out</h1>
    <p class="boxed-text-l">
        Kamu Berhasil Clock Out hari ini!<br>Selamat beristirahat.
    </p>
        ...
        function takeSnapshotLocationAndSubmit() {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    xhr.open('POST', '{{ route('clock-out') }}', true);
                    xhr.onload = function() {
